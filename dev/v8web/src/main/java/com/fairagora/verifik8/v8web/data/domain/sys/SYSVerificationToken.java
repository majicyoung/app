...
@Entity
@Table(name = "sys_verification_tokens")
public class SYSVerificationToken implements V8Entity {
    ...
    public SYSVerificationToken() {
        super();
    }

    public SYSVerificationToken(final String token) {
        super();
    ...
    public SYSVerificationToken(final String token, final SYSUser sysUser) {
        super();
    ...
    public boolean equals(final Object obj) {
        ...
        final SYSVerificationToken other = (SYSVerificationToken) obj;
        if (expiryDate == null) {
